...
CREATE TABLE `sys_menu` (
  ...
  `level` varchar(200) NOT NULL DEFAULT '' COMMENT '菜单层级',
  `url` varchar(200) DEFAULT '' COMMENT '菜单所对应的URL',
  `icon` varchar(20) DEFAULT '' COMMENT '图标',
  `type` varchar(1) DEFAULT '1' COMMENT '菜单类别，1菜单，2方法',
  `seq` int(11) NOT NULL DEFAULT '0' COMMENT '菜单在当前层级下的顺序，由小到大',
  `remark` varchar(200) DEFAULT '' COMMENT '备注',
  `operator` varchar(20) NOT NULL DEFAULT '' COMMENT '操作者',
  `operate_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最后一次操作时间',
  `operate_ip` varchar(20) NOT NULL DEFAULT '' COMMENT '最后一次更新操作者的ip地址',
...
insert  into `sys_menu`(`id`,`name`,`parent_id`,`level`,`url`,`icon`,`type`,`seq`,`remark`,`operator`,`operate_time`,`operate_ip`) values (1,'ç³»ç»ç®¡ç',0,'0','','#xe625;','1',0,'','ad','2018-01-19 13:59:57','df'),(2,'菜单管理',1,'0.1','sys/menu/toMenuPage?id=2','','1',0,'','admin','2018-01-19 14:00:29','127.0.0.1'),(3,'管理员管理',0,'0','','#xe62d;','1',0,'','asdf','2018-01-19 14:01:04','sadf');
