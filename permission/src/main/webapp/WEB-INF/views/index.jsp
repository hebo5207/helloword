...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs">H-ui.admin</a> <a
...
<aside class="Hui-aside">
    <div id="menuList" class="menu_dropdown bk_2">
        <%--<dl id="menu-article">
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="/sys/welcome/toWelcomePage.page"></iframe>
        </div>
    </div>
</section>
...
<%--一级菜单模板，使用的是Mustache模板 --%>
<script id="menuListTemplate" type="x-tmpl-mustache">
    {{#menuList}}
...
<%--二级菜单--%>
<script id="menuSonListTemplate" type="x-tmpl-mustache">
    <dd>
        <ul>
        {{#sysMenuDtos}}
            <li><a data-href="system-base.html" data-title="系统设置" href="javascript:void(0)">系统设置</a></li>
...
<script type="text/javascript">
    $(function () {
        var menuList;
        var menuListTemplate = $("#menuListTemplate").html();
        var menuSonListTemplate = $("#menuSonListTemplate").html();

        Mustache.parse(menuListTemplate);
        Mustache.parse(menuSonListTemplate);
                ...
                success: function (result) {
                    if (result.ret) {
                        ...
                        $(menuList).each(function (i, firstMenu) {
                            var appendFirst = Mustache.render(menuListTemplate, {menuList: firstMenu});
                            var appendSend = Mustache.render(menuSonListTemplate, {sysMenuDtos: firstMenu.sysMenuDtos});
                            $("#menuList").append(" <dl id=\"menu-" + firstMenu.id + "\">" + appendFirst + appendSend + "</dl>");
                        })

                    } else {
                        alert("加载菜单失败：" + result.msg);
                    }
                }
            });
        }
