...
<div class="main">
    ...
    <p class="text-c c-999">二级菜单不会显示图标，选了也没用</p>
...
<script type="application/javascript">
    ...
    $(".Hui-iconfont").click(function () {
        parent.$('#icons').val($(this).nextAll("div.code")[0].innerText.split("&")[1]);
        parent.$('.iconImg').html($(this).nextAll("div.code")[0].innerText);
